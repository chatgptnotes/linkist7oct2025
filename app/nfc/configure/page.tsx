        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="mt-8 bg-white rounded-lg border border-gray-200 p-6">
              <h2 className="text-lg font-semibold text-gray-900 mb-6">Customize Your Card</h2>
              
              {/* 1. Select Base */}
              <div className="mb-8">
                <h3 className="text-base font-medium text-gray-900 mb-2">1. Select Base</h3>
                <p className="text-sm text-gray-600 mb-4">Each material offers a unique feel and finish.</p>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-3">
                        <input 
                          ...
                          className="w-4 h-4 text-red-600 bg-gray-100 border-gray-300 focus:ring-red-500 focus:ring-2"
                        />
                        <span className="font-medium text-red-600">Stainless Steel</span>
                      </div>
              ...
              {/* 2. Select Texture */}
              <div className="mb-8">
                <h3 className="text-base font-medium text-gray-900 mb-2">2. Select Texture</h3>
                <p className="text-sm text-gray-600 mb-4">Each material offers a unique feel and finish.</p>
                  ...
                  >
                    <div className="flex items-center space-x-3">
                      <input 
                        ...
                        className="w-4 h-4 text-red-600 bg-gray-100 border-gray-300 focus:ring-red-500 focus:ring-2"
                      />
                      <span className="font-medium text-red-600">Metal Brushed Steel</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {/* 3. Select Pattern */}
              <div className="mb-8">
                <h3 className="text-base font-medium text-gray-900 mb-2">3. Select Pattern</h3>
                <p className="text-sm text-gray-600 mb-4">Choose a pattern for your card's background.</p>
                ...
                <div className="grid grid-cols-4 gap-3">
                  {[0, 1, 2, 3].map((pattern) => (
                    <div
                      ...
                      className={`aspect-square border rounded-lg cursor-pointer transition-all ${
                    ...
                    >
                      <div className="w-full h-full bg-gray-100 rounded-md flex items-center justify-center">
                        <div className="text-xs text-gray-500">Pattern {pattern + 1}</div>
                      </div>
                    </div>
                  ))}
                </div>
              ...
              {/* 4. Select Color */}
              <div className="mb-8">
                <h3 className="text-base font-medium text-gray-900 mb-2">3. Select Color</h3>
                <p className="text-sm text-gray-600 mb-4">Choose a color for your card's background.</p>
                
                <div className="flex space-x-4">
                  <div className="flex flex-col items-center space-y-2">
                    <div
                      onClick={() => setSelectedColor('black')}
                      className={`w-12 h-8 bg-gray-800 rounded cursor-pointer border-2 transition-all ${
                        selectedColor === 'black' ? 'border-red-500' : 'border-gray-300'
                      }`}
                    ></div>
                    <input 
                      type="radio" 
                  ...
                  <div className="flex flex-col items-center space-y-2">
                    <div
                      ...
                      className={`w-12 h-8 bg-gray-300 rounded cursor-pointer border-2 transition-all ${
                        selectedColor === 'silver' ? 'border-red-500' : 'border-gray-300'
                      }`}
                    ></div>
                    <input 
                      type="radio" 
                  ...
                  <div className="flex flex-col items-center space-y-2">
                    <div
                      ...
                      className={`w-12 h-8 bg-gray-500 rounded cursor-pointer border-2 transition-all ${
                        selectedColor === 'gray' ? 'border-red-500' : 'border-gray-300'
                      }`}
                    ></div>
                    <input 
                      type="radio" 
                  ...
                  <div className="flex flex-col items-center space-y-2">
                    <div
                      ...
                      className={`w-12 h-8 bg-yellow-500 rounded cursor-pointer border-2 transition-all ${
                        selectedColor === 'gold' ? 'border-red-500' : 'border-gray-300'
                      }`}
                    ></div>
                    <input 
                      type="radio" 
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                <div className="flex justify-between items-center text-sm mb-2">
                  ...
                  <span>${selectedBase === 'pvc' ? '29.00' : selectedBase === 'wood' ? '49.00' : '99.00'}</span>
                </div>
                <div className="flex justify-between items-center text-sm mb-2">
                ...
                <div className="border-t pt-3">
                  <div className="flex justify-between items-center text-lg font-bold">
                    ...
                    <span>${selectedBase === 'pvc' ? '99.00' : selectedBase === 'wood' ? '99.00' : '99.00'}</span>
                  </div>
                </div>
              </div>
